            ...
            if st.button("🚀 GENERATE WITH NANO", type="primary"):
                with st.spinner("Invoking Imagen 3..."):
                    try:
                        ...
                        img_resp = google_client.models.generate_images(model='imagen-3.0-generate-001', prompt=topic, config=types.GenerateImagesConfig(number_of_images=1, aspect_ratio="1:1", person_generation="ALLOW_ADULT"))
